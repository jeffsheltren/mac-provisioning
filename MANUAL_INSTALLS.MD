...
Just insert the passwords, they are stored in the keychain then. Favorites are the plist and can be exported by selecting and exporting all the favorites.
